import { ArrowUp, Play, Mail } from 'lucide-react'
      ...
      <div className="footer-social-section">
        ...
        <nav className="footer-nav" aria-label="Social and resource links">
          ...
          <a
            ...
            aria-label="Email OWASP PCCOE"
          >
            <Mail size={14} className="footer-social-icon" aria-hidden="true" />
            <span>owasp@pccoepune.org</span>
          </a>
        </nav>
      </div>
