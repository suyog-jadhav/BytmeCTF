import { ArrowUp, Play, Mail, PhoneCall } from 'lucide-react'
    ...
    <footer>
      ...
      <div className="footer-social-section">
        ...
        <nav className="footer-nav" aria-label="Social and resource links">
          ...
          <a
            href="mailto:owasp@pccoepune.org"
            className="footer-social-link footer-social-link--mail"
            aria-label="Email OWASP PCCOE (owasp@pccoepune.org)"
            title="Email: owasp@pccoepune.org"
          >
            <Mail size={20} className="footer-social-icon" aria-hidden="true" />
          </a>
          <button
            type="button"
            ...
            title="Contact Us"
          >
            <PhoneCall size={19} className="footer-social-icon" aria-hidden="true" />
          </button>
        </nav>
      </div>
